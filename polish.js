...
function buildDashboard() {
  ...
  container.innerHTML = `
    ...
    <div class="dashboard-panel extras-dashboard-panel" style="margin-bottom:14px;">
      <div class="panel-title">Last Week&#39;s Extras</div>
      <div id="extras-dashboard-content">${(typeof buildExtrasPanel === 'function') ? buildExtrasPanel() : '<div class="dash-empty">Skins and CTP results will appear here after Week 1.</div>'}</div>
    </div>
