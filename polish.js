// V4.6 polish layer — commissioner note + league leaders only
...
function getLeagueLeaders() {
  ...
  // Low Gross — lowest average total gross score per round
  ...
  // Low Net — lowest average total net score per round
